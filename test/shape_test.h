...
void shape_test_1()
{
	...
	string svg_filename = "shape_drawer_shape_test_1.svg";
	string png_filename = "shape_drawer_shape_test_1.png";
...
void arc_test()
{
	int radius = 400;
	Color background_color = Color(255, 105, 180);
	string svg_filename = "shape_drawer_arc_test_1.svg";
	string png_filename = "shape_drawer_arc_test_1.png";
	std::unordered_map<string, pair<string, string>> font_info{ {"yahei",make_pair("C:/Windows/Fonts/msyhl.ttc", "microsoft yahei")} };
	Point center(400, 400);
	auto c_pi = free_angle::from_angle(180);
	...
	arcs.push_back(arc_2);
	arcs.push_back(arc_3);
	for (const auto& one_arc : arcs)
	{
		svg_graph << one_arc;
		png_image << one_arc;
	}
...
void line_test()
{
	int radius = 400;
	Color background_color = Color(255, 105, 180);
	string svg_filename = "shape_drawer_line_test_1.svg";
	string png_filename = "shape_drawer_line_test_1.png";
	std::unordered_map<string, pair<string, string>> font_info{ {"yahei",make_pair("C:/Windows/Fonts/msyhl.ttc", "microsoft yahei")} };
	Point center(400, 400);
	auto c_pi = free_angle::from_angle(180);
...
void circle_test()
{
	int radius = 400;
	Color background_color = Color(255, 105, 180);
	string svg_filename = "shape_drawer_circle_test_1.svg";
	string png_filename = "shape_drawer_circle_test_1.png";
	std::unordered_map<string, pair<string, string>> font_info{ {"yahei",make_pair("C:/Windows/Fonts/msyhl.ttc", "microsoft yahei")} };
	Point center(400, 400);
	auto c_pi = free_angle::from_angle(180);
	...
	circles.push_back(circle_3);
	for (const auto& one_circle : circles)
	{
		svg_graph << one_circle;
		png_image << one_circle;
	}
}